...
def events(put,link):
    ...
    if any(word in put for word in youtube_keywords):
        try:
            ...
            speak.Speak('Sorry Ethan. Looks like its not working!')
...
#Who are you?
    ...
    try:
        speak.Speak("I am BENJI, a digital assistant declassified for civilian use. Previously I was used by the Impossible Missions Force")
            ...
            speak.Speak('Error. Try reading the ReadMe to know about me!')
...
#Open a webpage
    ...
    try:
        ...
        webbrowser.open('http://www.'+link[1]+'.com')
            ...
            speak.Speak('Sorry Ethan,unable to access it. Cannot hack either-IMF protocol!')
    ...
    try:
        ...
        webbrowser.open('https://www.google.com/search?q='+link)
            ...
            speak.Speak('Nope, this is not working.')
    ...
    try:
        ...
        webbrowser.open(wikisearch.url)
            ...
            speak.Speak('Wikipedia could not either find the article or your Third-world connection is unstable')
    ...
    try:
        ...
        ctypes.windll.user32.LockWorkStation()
            ...
            speak.Speak('Cannot lock device')
...
#News of various press agencies
    ...
    try:
        ...
        speak.Speak('Qatari agents have refused to share this intel, Ethan')
    ...
    try:
        ...
        speak.Speak('MI6 is going crazy! Not allowing this!')
    ...
    try:
        ...
        speak.Speak('Connection not secure')
    ...
    try:
        ...
        speak.Speak('R&A W is blocking our reports, Ethan. Sorry! ')
