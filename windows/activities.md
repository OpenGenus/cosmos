...
NOTE: Try different expression to make B.E.N.J.I. more secure. Make sure to make a folder named "recognizer" in "C" drive. This will store the trained model. "dataset" folder will be auto created. It will store the images fetched.
