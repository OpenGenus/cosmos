...
ptrdiff_t linear_search(_Value_Type const *const arr, size_t const &sz, _Value_Type const &find);
*/
...
void test() {
    ...
    for (int i = 0; i < 2; ++i)
        plain_arr2[i] = i;
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr2, sizeof(plain_arr2) / sizeof(plain_arr2[0]), 0),
              (ptrdiff_t)0);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr2, sizeof(plain_arr2) / sizeof(plain_arr2[0]), 1),
              (ptrdiff_t)1);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr2, sizeof(plain_arr2) / sizeof(plain_arr2[0]), -1),
              (ptrdiff_t)-1);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr2, sizeof(plain_arr2) / sizeof(plain_arr2[0]), 2),
              (ptrdiff_t)-1);
    ...
    for (int i = 0; i < 3; ++i)
        plain_arr3[i] = i;
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr3, sizeof(plain_arr3) / sizeof(plain_arr3[0]), 0),
              (ptrdiff_t)0);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr3, sizeof(plain_arr3) / sizeof(plain_arr3[0]), 2),
              (ptrdiff_t)2);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr3, sizeof(plain_arr3) / sizeof(plain_arr3[0]), -1),
              (ptrdiff_t)-1);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr3, sizeof(plain_arr3) / sizeof(plain_arr3[0]), 3),
              (ptrdiff_t)-1);
    ...
    for (int i = 0; i < 100; ++i)
        plain_arr4[i] = i;
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr4, sizeof(plain_arr4) / sizeof(plain_arr4[0]), 0),
              (ptrdiff_t)0);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr4, sizeof(plain_arr4) / sizeof(plain_arr4[0]), 99),
              (ptrdiff_t)99);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr4, sizeof(plain_arr4) / sizeof(plain_arr4[0]), -1),
              (ptrdiff_t)-1);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr4, sizeof(plain_arr4) / sizeof(plain_arr4[0]), 100),
              (ptrdiff_t)-1);
    ...
    for (int i = 0; i < 101; ++i)
        plain_arr5[i] = i;
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr5, sizeof(plain_arr5) / sizeof(plain_arr5[0]), 0),
              (ptrdiff_t)0);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr5, sizeof(plain_arr5) / sizeof(plain_arr5[0]), 100),
              (ptrdiff_t)100);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr5, sizeof(plain_arr5) / sizeof(plain_arr5[0]), -1),
              (ptrdiff_t)-1);
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr5, sizeof(plain_arr5) / sizeof(plain_arr5[0]), 101),
              (ptrdiff_t)-1);

    int plain_arr6[] = {1, 2, 2};
    my_assert("error line at: " + std::to_string(__LINE__),
              linear_search(plain_arr6, sizeof(plain_arr6) / sizeof(plain_arr6[0]), 2),
              (ptrdiff_t)1);
