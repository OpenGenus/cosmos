...
int main()
{
    ...
    assert(spiralPrint(vec, vec.size(), vec[0].size()) == "1 2 3 4 5 6 12 18 17 16 15 14 13 7 8 9 10 11");
    vec.push_back({19, 20, 21, 22, 23, 24});
    assert(spiralPrint(vec, vec.size(), vec[0].size()) == "1 2 3 4 5 6 12 18 24 23 22 21 20 19 13 7 8 9 10 11 17 16 15 14");
