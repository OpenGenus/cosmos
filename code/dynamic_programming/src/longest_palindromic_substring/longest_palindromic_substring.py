def longest_pal(test_num):
    ...
    pal_boolean_array = [
        [False for e in range(len(num))] for s in range(len(num))]
    ...
    for lengths_to_check in range(3, len(num) + 1):  # lengths greater than 2
        for s in range(len(num) - lengths_to_check + 1):
            other_characters_symmetry = pal_boolean_array[s +
                                                          1][s + lengths_to_check - 2]
            palindrome_boolean = num[s] == num[s +
                                               lengths_to_check -
                                               1] and other_characters_symmetry
