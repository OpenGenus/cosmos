...
class FCFS():
    ...
    def Print(self):
        ...
        print("FORMAT : process_name -> arrival_time -> burst_time -> waiting_time -> turn_arround_time\n")
        for process in self.__processes:
            print(process, self.__processes[process][0], self.__processes[process][1], self.__wtList[l], self.__taList[l], sep=" -> ")
