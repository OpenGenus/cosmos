...
std::vector<std::vector<int>> naive_multi(const std::vector<std::vector<int>>& a, const std::vector<std::vector<int>>& b) {
    int s = 0;
    std::vector<std::vector<int>> ans;
    for (std::vector<std::vector<int>>::size_type i = 0; i < a.size(); i++) {
        vector<int> row;
...
std::vector<std::vector<int>> strassen(const std::vector<std::vector<int>>& m1, const std::vector<std::vector<int>>& m2) {
...
std::vector<std::vector<int>> fast_multi(const std::vector<std::vector<int>>& m1, const std::vector<std::vector<int>>& m2){
