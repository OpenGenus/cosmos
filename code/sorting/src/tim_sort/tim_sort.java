...
class TimSort {
    ...
    Example:
      ...
      Final order of array:
        ...
        [ 1  2  5  10  23 ]
    ******************************************************************/
    public static void insertionSort(int[] A, int start_i, int end_i) {
    ...
    *****************************************************************/
    public static void merge(int[] A, int left_i, int mid_i, int right_i) {
        ...
        int[] left_A = new int[left_len];
        int[] right_A = new int[right_len];
        ...
        // if there are any reamining elements from
        ...
        // the right array, addd them to array A
        while (r < right_len) {
            A[pos] = right_A[r];
            pos++;
            r++;
    ...
    **********************************************************/
    public static void timSort(int[] A, int n) {
        ...
        int minRun = calcMinRun(MIN_MERGE);

        // sort subarrays of A of size minRun
        for (int i = 0; i < n; i += minRun) {
            if (i + minRun - 1 < n - 1) {
                insertionSort(A, i, i + minRun - 1);
            } else {
        ...
        for (int len = minRun; len < n; len = 2 * len) {
            ...
            for (int left = 0; left < n; left += 2 * len) {
                ...
                // merge left and right subarrays, i.e.
