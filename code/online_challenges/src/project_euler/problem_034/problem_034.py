...
FACTORIAL_DIGITS_SUM_WITHOUT_LEADING_ZEROS = [sum(factorial(int(c)) for c in str(i)) for i in xrange(10000)]
FACTORIAL_DIGITS_SUM_WITH_LEADING_ZEROS = [sum(factorial(int(c)) for c in str(i).zfill(4)) for i in xrange(10000)]
